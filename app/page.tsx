  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-white max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-light tracking-[0.3em] mb-4">
              TELLING YOUR STORY
            </h1>
            <p className="text-lg tracking-wide font-light mb-8">
              IN FRAMES AND MOTION
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-light tracking-wide text-stone-800 mb-4">
              WEDDING,EVENT and LIFESTYLE Production
            </h2>
            <p className="text-stone-600 max-w-2xl mx-auto leading-relaxed">
              Faabs Production is a Ghana-based photography and videography
              brand committed to capturing unforgettable moments through
              creative visuals.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-12 lg:col-span-5">
              <div className="pr-8">
                <h2 className="text-4xl font-light tracking-wide text-stone-800 mb-8">
                  HERE&#39;S TO LIFE
                </h2>
                <p className="text-stone-600 leading-relaxed mb-6">
                  At Faabs Production, we believe that every moment tells a
                  story worth preserving. With years of experience in weddings,
                  events, portraits, and commercial shoots, we tell your story
                  with style and emotion.
                </p>
                <p className="text-stone-600 leading-relaxed mb-8">
                  From intimate ceremonies to grand celebrations, we capture the
                  essence of your special moments with artistic vision and
            ...
            <div className="col-span-12 lg:col-span-7">
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -right-8 bg-white p-6 shadow-lg">
                  <p className="text-sm tracking-wide text-stone-600 italic">
                    Capture the magic &
                  </p>
                  <p className="text-sm tracking-wide text-stone-600 italic">
                    live the moment
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl font-light tracking-wide text-stone-800 text-center mb-4">
              OUR SERVICES
            </h2>
          </div>
      ...
      <section className="relative py-32">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-light tracking-wide mb-8">MISSION </h2>
          <p className="text-lg leading-relaxed opacity-90 max-w-2xl mx-auto">
            Our mission is to create timeless visual narratives that celebrate
            life&#39;s most precious moments. We believe in the power of
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-stone-700 leading-relaxed italic mb-8">
              &quotFaabs Production made our wedding day unforgettable. Every
              photo was magical! Their attention to detail and ability to
              capture emotions is truly remarkable.&quot
            </p>
            ...
            <div className="col-span-12 lg:col-span-6">
              ...
              <div className="space-y-4 mb-8">
                <p className="text-stone-700">
                  <span className="text-sm tracking-wide text-stone-500">
                    CALL/WHATSAPP:
                  </span>
                  <br />
                  +233 24 000 0000
