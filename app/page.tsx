              ...
              <div className="col-span-12 lg:col-span-5">
                <div className="pr-8">
                  ...
                  <p className="text-stone-600 leading-relaxed mb-6">
                    ...
                    story worth preserving. With years of experience in
                    weddings, events, portraits, and commercial shoots, we tell
                    your story with style and emotion.
                  </p>
                  <p className="text-stone-600 leading-relaxed mb-8">
                    From intimate ceremonies to grand celebrations, we capture
                    the essence of your special moments with artistic vision and
